...
function ContactForm({ title = "Contact Us Today", description = "We'd love to hear from you!", onSubmit }: any) {
        ...
        <div className="bg-white p-12 w-full">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 p-6">
                ...
                <div className="flex justify-center">
                    <button
                        type="submit"
                        className="bg-green-500 hover:bg-green-900 text-white font-bold py-3 px-6 rounded-lg transition-transform transform hover:scale-105"
                    >
                        Send Message
                    </button>
                </div>
